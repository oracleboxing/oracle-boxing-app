  ...
  public: {
    Tables: {
      ...
      workout_item_moves: {
        ...
        Update: Partial<Database['public']['Tables']['workout_item_moves']['Insert']>
      }
      workout_item_combinations: {
        ...
        Update: Partial<Database['public']['Tables']['workout_item_combinations']['Insert']>
      }
      user_profiles: {
        Row: {
          id: string
...
export type WorkoutItemMove = Database['public']['Tables']['workout_item_moves']['Row']
export type WorkoutItemCombination = Database['public']['Tables']['workout_item_combinations']['Row']
